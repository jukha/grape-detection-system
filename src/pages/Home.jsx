                ...
                <ul className="pera-bottom mb-30">
                  <ul>
                    <li>
                      ...
                      resveratrol, and quercetin, which help neutralize harmful
                    ...
                    <li>
                      ...
                      The high levels of polyphenols in grapes have been linked
                      to improved heart health by promoting healthy blood
                      circulation, reducing blood pressure, and supporting
                    ...
                    <li>
                      ...
                      compounds that help strengthen the body's defense system,
                      making it more resistant to infections and illnesses.
                    </li>
                    <li>
                      <span className="font-weight-bold">
                        Digestive Health:
                      ...
                      digestion, promotes regular bowel movements, and supports
            ...
            <div className="card" style={{ width: "44rem" }}>
              ...
              <div className="card-body">
                ...
                <p className="card-text">
                  Some quick example text to build on Some quick example text to
                  build on
                </p>
